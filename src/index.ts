import type { LockPlugin } from '@easepick/lock-plugin';
import { BasePlugin, IEventDetail, IPlugin, IBaseConfig } from '@easepick/base-plugin';
...
export class AmpPlugin extends BasePlugin implements IPlugin {
  ...
  public options: IAmpPlugin = {
    ...
    darkMode: true,
    locale: {
      resetButton: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="24" width="24">
